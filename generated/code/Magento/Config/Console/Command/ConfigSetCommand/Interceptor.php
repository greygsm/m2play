...
class Interceptor extends \Magento\Config\Console\Command\ConfigSetCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Config\Console\Command\EmulatedAdminhtmlAreaProcessor $emulatedAreaProcessor, \Magento\Deploy\Model\DeploymentConfig\ChangeDetector $changeDetector, \Magento\Config\Console\Command\ConfigSet\ProcessorFacadeFactory $processorFacadeFactory, \Magento\Framework\App\DeploymentConfig $deploymentConfig, ?\Magento\Config\Console\Command\LocaleEmulatorInterface $localeEmulator = null)
    {
        $this->___init();
        parent::__construct($emulatedAreaProcessor, $changeDetector, $processorFacadeFactory, $deploymentConfig, $localeEmulator);
    }
