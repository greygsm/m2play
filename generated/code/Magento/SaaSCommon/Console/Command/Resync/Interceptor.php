...
class Interceptor extends \Magento\SaaSCommon\Console\Command\Resync implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\SaaSCommon\Model\ResyncManagerPool $resyncManagerPool, $name = '', $feedNames = [])
    {
        $this->___init();
        parent::__construct($resyncManagerPool, $name, $feedNames);
    }
