    ...
    function (
        ...
        return Component.extend({
                    ...
                    braintree.create({
                        ...
                        lpm.create({
                            ...
                            lpmInstance.startPayment({
                                ...
                                // Therefore, both values are set to allow the payment flow to continue, rather than error out.
                                fallback: {
            ...
            isValidCountryAndCurrency: function (method) {
                ...
                let quoteCurrency = quote.totals()['base_currency_code'];
                let paymentMethodDetails = this.getPaymentMethod(method);
